...
Autodesk.ADN.Viewing.Extension.Physics = function (viewer, options) {
    ...
    _self.load = function () {
        ...
        $.when(
            $.getScript('https://rawgit.com/kripken/ammo.js/master/builds/ammo.js'),
            $.getScript('https://rawgit.com/darsain/fpsmeter/master/dist/fpsmeter.min.js'),
            $.getScript('https://ajax.googleapis.com/ajax/libs/angularjs/1.3.8/angular.min.js'),
            $.getScript('https://rawgit.com/vitalets/angular-xeditable/master/dist/js/xeditable.min.js'),
