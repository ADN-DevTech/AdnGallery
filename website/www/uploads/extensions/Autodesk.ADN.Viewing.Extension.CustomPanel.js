...
Autodesk.ADN.Viewing.Extension.CustomPanel = function (viewer, options) {
    ...
    _self.load = function () {
        ...
        Autodesk.ADN.AdnPanel = function(
            parentContainer, id, title, content, x, y)
        {
        ...
        _panel = Autodesk.ADN.AdnPanel(
            _viewer.clientContainer,
            'adn-panel', 'ADN Demo Panel',
            null, 0, 0);

        console.log('Autodesk.ADN.Viewing.Extension.CustomPanel loaded');
    ...
    _self.unload = function () {
        ...
        console.log('Autodesk.ADN.Viewing.Extension.CustomPanel unloaded');

        return true;
    };
};

Autodesk.ADN.Viewing.Extension.CustomPanel.prototype =
    Object.create(Autodesk.Viewing.Extension.prototype);

Autodesk.ADN.Viewing.Extension.CustomPanel.prototype.constructor =
    Autodesk.ADN.Viewing.Extension.CustomPanel;
